...
from .XiangqiNNet import XiangqiNNet as xnnet
...
class NNetWrapper(NeuralNet):
    def __init__(self, game):
        self.nnet = xnnet(game, args)
        self.planes, self.board_x, self.board_y = game.getBoardSize()
    ...
    def predict(self, board):
        ...
        board = board.view(1, self.planes, self.board_x, self.board_y)
        self.nnet.eval()
        with torch.no_grad():
