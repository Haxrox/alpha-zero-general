...
class XiangqiNNet(nn.Module):
    def __init__(self, game, args):
        # game params
        self.board_planes, self.board_x, self.board_y = game.getBoardSize()
    ...
    def forward(self, s):
        ...
        s = s.view(-1, 1, self.board_planes, self.board_x, self.board_y)                # batch_size x 1 x board_x x board_y
